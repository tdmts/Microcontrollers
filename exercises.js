...
window.LAB_EXERCISES = {
    ...
    labo6: {
        ...
        exercises: [
            ...
            { id: 'boodschappenmetsleutel', order: 6, name: 'Drie soorten boodschappen uit elkaar houden', href: 'https://tdmts.github.io/Microcontrollers/Labo6/Exercises/BoodschappenMetEenSleutel.html', checklistDriven: true, difficulty: 2, time: '~35 min', blurb: 'Zet een sleutel voor elke waarde, splits op de dubbelepunt, en je ontvanger raakt nooit meer in de war over wat hij leest.' },
