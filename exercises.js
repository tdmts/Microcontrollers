...
window.LAB_EXERCISES = {
    labo0: {
        ...
        labTitle: 'Labo 0',
        exercises: [
            { id: 'blink', order: 1, name: 'Blink', href: 'https://tdmts.github.io/Microcontrollers/Labo0/Exercises/Blink.html', checklistDriven: true, difficulty: 1, time: '~10 min', blurb: 'Je allereerste sketch: laat een ingebouwde led knipperen en pas het knipperritme aan.' },
    ...
    labo6: {
        ...
        labTitle: 'Labo 6',
        exercises: [
            { id: 'ledvanuitmonitor', order: 1, name: 'Led schakelen vanuit de seriële monitor', href: 'https://tdmts.github.io/Microcontrollers/Labo6/Exercises/LedSchakelenVanuitDeMonitor.html', checklistDriven: true, difficulty: 1, time: '~20 min', blurb: 'Typ een 1 of een 0 in de monitor en schakel er een led mee. Voor het eerst stuur jij iets naar de Arduino in plaats van omgekeerd.' },
            { id: 'getalnaartweedearduino', order: 2, name: 'Een getal doorsturen naar een tweede Arduino', href: 'https://tdmts.github.io/Microcontrollers/Labo6/Exercises/GetalNaarTweedeArduino.html', checklistDriven: true, difficulty: 1, time: '~25 min', blurb: 'Kruis Tx en Rx, leg een gemeenschappelijke massa, en ontdek welke vijf bytes er echt over de draad gaan als je 100 verstuurt.' },
            { id: 'drukknophierleddaar', order: 3, name: 'Een drukknop hier, een led daar', href: 'https://tdmts.github.io/Microcontrollers/Labo6/Exercises/DrukknopHierLedDaar.html', checklistDriven: true, difficulty: 2, time: '~25 min', blurb: 'Laat de ene Arduino de andere een opdracht geven, en stuur alleen iets door wanneer de knop echt van stand verandert.' },
            { id: 'potentiometerdoorsturen', order: 4, name: 'Een potentiometerwaarde doorsturen en dimmen', href: 'https://tdmts.github.io/Microcontrollers/Labo6/Exercises/PotentiometerwaardeDoorsturen.html', checklistDriven: true, difficulty: 2, time: '~30 min', blurb: 'Stuur een meting in plaats van een commando, en ondervind waarom je niet sneller mag zenden dan de lijn aankan.' },
            { id: 'driegetallenoptellen', order: 5, name: 'Drie getallen doorsturen en optellen', href: 'https://tdmts.github.io/Microcontrollers/Labo6/Exercises/DrieGetallenOptellen.html', checklistDriven: true, difficulty: 2, time: '~30 min', blurb: 'Meerdere waarden na elkaar over dezelfde lijn, en een reset halverwege die laat zien hoe een ontvanger het spoor bijster raakt.' },
            { id: 'boodschappenmetsleutel', order: 6, name: 'Drie soorten boodschappen uit elkaar houden', href: 'https://tdmts.github.io/Microcontrollers/Labo6/Exercises/BoodschappenMetEenSleutel.html', checklistDriven: true, difficulty: 2, time: '~35 min', blurb: 'Zet een sleutel voor elke waarde en splits op de dubbelepunt, zodat je ontvanger van elke boodschap weet wat ze voorstelt.' },
    ...
    labo7: {
        ...
        labTitle: 'Labo 7',
        exercises: [
            { id: 'ledaanmetinterrupt', order: 1, name: 'Een led die aangaat zonder loop', href: 'https://tdmts.github.io/Microcontrollers/Labo7/Exercises/LedAanMetEenInterrupt.html', checklistDriven: true, difficulty: 1, time: '~20 min', blurb: 'Je eerste interrupt. Je loop blijft helemaal leeg en toch reageert je led op de knop.' },
            ...
            { id: 'looplichtmetnoodstop', order: 3, name: 'Noodstop op je looplicht', href: 'https://tdmts.github.io/Microcontrollers/Labo7/Exercises/LooplichtMetNoodstop.html', checklistDriven: true, difficulty: 2, time: '~30 min', blurb: 'Het looplicht uit labo 1 krijgt een noodknop die werkt terwijl je programma in een delay zit.' },
