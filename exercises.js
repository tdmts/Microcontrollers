...
window.LAB_EXERCISES = {
    ...
    labo1: {
        ...
        exercises: [
            ...
            { id: 'dubbel7segment', order: 5, name: 'Dubbel 7 segment', href: 'https://tdmts.github.io/Microcontrollers/Labo1/Exercises/Dubbel7Segment.html', checklistDriven: true, difficulty: 2, time: '~25 min', blurb: 'Stuur een dubbel 7-segment display aan in een 8-animatie.' },
